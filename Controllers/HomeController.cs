...
namespace WaterProject.Controllers
{
    ...
    {
        // REPOSITORY FORMAT - more used in industry and can more easily access data from the database
        ...
        //Lambda says "the result of this function is this thing" DOES NOT WORK if you ahve to do more things in the function!!
        ...
        //public IActionResult Index() => View(); //This is the exact same thing as above! Lambda (=>) is just a shortcut
    }
}
